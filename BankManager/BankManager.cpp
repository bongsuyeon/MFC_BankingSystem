...
// BankManager.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BOOL CBankManagerApp::OpenDatabase()
{
	TRY
	{
		g_dbAlbum.OpenEx(_T("DSN=Banking;UID=;PWD="), CDatabase::noOdbcDialog);
	/*		CString strDSN;
...
{
	//SetDialogBkColor(RGB(255, 150, 150));
